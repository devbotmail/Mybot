...
| Info | Programs | LINK |
|-----|--------|--------|
| Down & Install | **Git** |[here](https://git-scm.com/downloads) |
| Down & Install | **NodeJs** |[here](https://nodejs.org/en/download) | \n(**Add FFmpeg to PATH enviroment variables**)
| Down & Install | **Ffmpeg** |[here](https://ffmpeg.org/download.html) | 
